...
class ChangeLogConsumer {
	...
	final private LinkedBlockingQueue<JSONObject> pendingInstructions = new LinkedBlockingQueue<JSONObject>(
			RestServices.MAXPOLLQUEUE_LENGTH);
	...
	private void writePendingChanges() {
		...
		// PrintWriter(continuation.getServletResponse().getOutputStream());
